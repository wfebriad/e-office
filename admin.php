                  ...
                  <div class="card">
                    <div class="card-content">
                      ...
                      <p class="description">Anda login sebagai
                        <?php
    if($_SESSION['admin'] == 1){
        echo "<strong>Super Administrator</strong>. Anda memiliki akses penuh terhadap sistem.";
    } elseif($_SESSION['admin'] == 2){
        echo "<strong>Kepala Bagian</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
    } else {
        echo "<strong>Eselon IV</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
    }?></p>
                    </div>
                  </div>
                </div>
