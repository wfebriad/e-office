                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            <div class="disp hidd">';
                                ...
                                list($nama, $kementerian, $kntr_pst, $alamat, $logo) = mysqli_fetch_array($query2);
                                if(!empty($logo)){
                                ...
                                if(!empty($kntr_pst)){
                                    echo '<h6 class="up">'.$kntr_pst.'</h6>';
                                } else {
                                    echo '<h6 class="up">DIREKTORAT JENDERAL PERHUBUNGAN LAUT</h6>';
                                }
                                if(!empty($nama)){
                                    echo '<h6 class="up" id="nama">'.$nama.'</h6><br/>';
                                } else {
                                    echo '<h6 class="up" id="nama">DISTRIK NAVIGASI KELAS I TANJUNGPINANG</h6><br/>';
                                }
                                if(!empty($kementerian)){
                                    echo '<h6 class="kementerian">'.$kementerian.'</h6>';
                                } else {
                                    echo '<h6 class="kementerian">KEMENTERIAN PERHUBUNGAN</h6>';
                                }
                                if(!empty($alamat)){
