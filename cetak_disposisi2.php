        ...
        <div class="container">
            <div id="colres">
                <div class="disp">';
                    ...
                    if(!empty($status)){
                        echo '<h6 class="up">'.$status.'</h6>';
                    } else {
                        echo '<h6 class="up">KEMENTRIAN PERHUBUNGAN</h6>';
                    }
                    if(!empty($institusi)){
                        echo '<h6 class="up" id="nama">'.$institusi.'</h6><br/>';
                    } else {
                        echo '<h6 class="up" id="nama">DIREKTORAT JENDERAL PERHUBUNGAN LAUT</h6><br/>';
                    }
                    if(!empty($nama)){
                        echo '<h5 class="status">'.$nama.'</h5>';
                    } else {
                        echo '<h5 class="status">DISTRIK NAVIGASI KELAS 1 TAMJUNGPINANG</h5>';
                    }
                    if(!empty($alamat)){
