...
if(empty($_SESSION['admin'])){
    ...
    if(mysqli_num_rows($query) > 0){
        ...
        while($row = mysqli_fetch_array($query)){
            ...
            if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['admin'] != 1 AND $_SESSION['id_user'] != $row['id_user'] AND $_SESSION['admin'] != 2){
                ...
                if(mysqli_num_rows($query2) > 0){
                    ...
                    while($row = mysqli_fetch_array($query2)){
                        ...
                        if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1){
                            echo '<a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_disposisi='.$row['id_surat'].'" target="_blank">
