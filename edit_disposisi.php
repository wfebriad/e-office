    ...
    <div class="row jarak-form">
      ...
      <form class="col s12" method="post" action="">
        ...
        <div class="row">
          <div class="input-field col s6"> <i class="material-icons prefix md-prefix">description</i>
            ...
            <?php
                if(isset($_SESSION['tujuan'])){
                    $isi_disposisi = $_SESSION['tujuan'];
                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$tujuan.'</div>';
                    unset($_SESSION['isi_disposisi']);
                }
                ?>
              <label for="isi_disposisi">Tujuan Disposisi</label>
          </div>
          <div class="input-field col s6"> <i class="material-icons prefix md-prefix">description</i>
            <input id="isi_disposisi" type="text" class="validate" name="isi_disposisi" value="<?php echo $row['isi_disposisi'] ;?>" required>
          ...
          <div class="input-field col s6"> <i class="material-icons prefix md-prefix">alarm</i>
          ...
          <div class="input-field col s6"> <i class="material-icons prefix md-prefix">low_priority</i>
            <label>Pilih Sifat Disposisi</label>
            <br/>
            <div class="input-field col s11 right">
              <select class="browser-default validate" name="sifat" id="sifat" required>
                <option value="<?php echo $row['sifat']; ?>">
                  <?php echo $row['sifat']; ?>
                </option>
        ...
        <div class="row">
          ...
          <div class="col 6"> <a href="?page=tsm&act=disp&id_surat=<?php echo $row['id_surat']; ?>" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a> </div>
        </div>
      </form>
      <!-- Form END -->
    </div>
