            ...
            ?> <span class="white-text">&copy; <?php echo date("Y"); ?>
                <?php
                    if(!empty($data['nama'])){
                        ...
                        echo 'Distrik Navigasi Kelas 1 Tanjungpinang  &nbsp;|&nbsp; <a class="white-text" href="http://www.disnavtanjungpinang.id" target="_blank">Distrik Navigasi Kelas 1 Tanjungpinang</a>';
                    }
                ?>
            </a>
            </span>
                    ...
                    if(!empty($data['website'])){
                        ...
                        echo '<i class="material-icons md-12">public</i> disnavtanjungpinang.id &nbsp;&nbsp;';
                    }
                    if(!empty($data['email'])){
                        echo '<i class="material-icons">mail_outline</i> '.$data['email'].'';
                    } else {
                        echo '<i class="material-icons">mail_outline</i>  disnavtanjungpinang@dephub.go.id';
                    }
                }
                ?> </div>
            </div>
