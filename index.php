...
?>
    ...
    <head>
        <title>E-Office Distrik Navigasi Kelas 1 Tanjungpinang</title>
        <!-- Meta START -->
        <meta charset="utf-8" />
    ...
    <body class="blue-grey lighten-3 bg">
            ...
            <div class="row">
                ...
                <div class="col s12 m6 offset-m3 offset-m3">
                    ...
                    ?>
                                ...
                                <div class="col s12">
                                    <div class="card-content">
                                        <h5 class="center" id="smk">E-Office</h5>
                                        <?php
                                if(!empty($data['logo'])){
                            ...
                            <?php
                                if(!empty($data['nama'])){
                                    ...
                                    echo 'Distrik Navigasi Kelas 1 Tanjungpinang';
                                }
                             ?>
                            </h4>
                                            <div class="batas"></div>
                    ...
                    ?>
                            ...
                            ?> </div>
                                            <div class="input-field col s12"> <i class="material-icons prefix md-prefix">account_circle</i>
                                                <input id="username" type="text" class="validate" name="username" required autocomplete="off">
                                                <label for="username">Username</label>
                                            </div>
                                            <div class="input-field col s12"> <i class="material-icons prefix md-prefix">lock</i>
        ...
        <!-- Javascript END -->
        <noscript>
            <meta http-equiv="refresh" content="0;URL='./enable-javascript.html'" /> </noscript>
    </body>
    <!-- Body END -->
