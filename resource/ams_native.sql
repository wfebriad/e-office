...
CREATE TABLE `tbl_instansi` (
  ...
  `kntr_pst` varchar(150) NOT NULL,
  `nama` varchar(150) NOT NULL,
  `kementerian` varchar(150) NOT NULL,
  `alamat` varchar(150) NOT NULL,
  `kep_inst` varchar(50) NOT NULL,
...
INSERT INTO `tbl_instansi` (`id_instansi`, `kntr_pst`, `nama`, `kementerian`, `alamat`, `kep_inst`, `nip`, `website`, `email`, `logo`, `id_user`) VALUES
