    ...
    <?php
        ...
        <div class="row jarak-form">
            ...
            <form class="col s12" method="post" action="?page=ref&act=add">
                <!-- Row in form START -->
                <div class="row">
                    <div class="input-field col s3 tooltipped" data-position="top" data-tooltip="Isi dengan huruf, angka, spasi dan titik(.)"> <i class="material-icons prefix md-prefix">font_download</i>
                    ...
                    <div class="input-field col s9"> <i class="material-icons prefix md-prefix">text_fields</i>
                    ...
                    <div class="input-field col s12"> <i class="material-icons prefix md-prefix">subject</i>
                ...
                <div class="row">
                    ...
                    <div class="col 6"> <a href="?page=ref" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a> </div>
                </div>
            </form>
            <!-- Form END -->
        </div>
