    ...
    <?php
        ...
        <div class="row jarak-form">
            ...
            <form class="col s12" method="POST" action="?page=tsm&act=add" enctype="multipart/form-data">
                <!-- Row in form START -->
                <div class="row">
                    <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi dengan angka"> <i class="material-icons prefix md-prefix">looks_one</i>
                    ...
                    <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Diambil dari data referensi kode klasifikasi"> <i class="material-icons prefix md-prefix">bookmark</i>
                    ...
                    <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi dengan huruf atau angka"> <i class="material-icons prefix md-prefix">storage</i>
                    ...
                    <div class="input-field col s6"> <i class="material-icons prefix md-prefix">looks_two</i>
                    ...
                    <div class="input-field col s6"> <i class="material-icons prefix md-prefix">date_range</i>
                    ...
                    <div class="input-field col s6"> <i class="material-icons prefix md-prefix">description</i>
                    ...
                    <div class="input-field col s6"> <i class="material-icons prefix md-prefix">featured_play_list</i>
                        ...
                        <div class="file-field input-field tooltipped" data-position="top" data-tooltip="Jika tidak ada file/scan gambar surat, biarkan kosong">
                            ...
                            <div class="file-path-wrapper">
                                ...
                                <?php
                                        ...
                                        ?> <small class="red-text">*Format file yang diperbolehkan *.JPG, *.PNG, *.DOC, *.DOCX, *.PDF dan ukuran maksimal file 2 MB dan batas nama file maksimal hanya 5-6 suku kata :v !</small> </div>
                        </div>
                    </div>
                </div>
                <!-- Row in form END -->
                <div class="row">
                    ...
                    <div class="col 6"> <a href="?page=tsm" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a> </div>
                </div>
            </form>
            <!-- Form END -->
        </div>
